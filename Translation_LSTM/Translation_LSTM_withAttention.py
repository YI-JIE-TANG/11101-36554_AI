...
from tensorflow.keras.layers import Input, LSTM, GRU, Dense, Concatenate, TimeDistributed
...
data_path = 'cmn.txt' #'English2TraChinese.txt'
...
concatenate = Concatenate(axis=-1, name='concat_layer')
...
attn_out, attn_states = attn_layer([Input_encoder_outputs, decoder_outputs])
decoder_concat_input = concatenate([decoder_outputs, attn_out])
decoder_outputs = decoder_dense(decoder_concat_input)
...
def decode_sequence(input_seq):
    ...
    print(encoder_output_seqs.shape)
